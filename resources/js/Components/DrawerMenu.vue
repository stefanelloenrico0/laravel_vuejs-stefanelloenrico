...
<template>
    <div>
        <Drawer v-model:visible="props.visible" class="h-[100%]">
            <template #container="{ closeCallback }">
                <div class="flex flex-col h-full drawerElements">
                    <div class="flex items-center justify-between px-6 pt-4 shrink-0">
                        ...
                        <span>
                            <Button type="button" @click="closeDrawerMenu" icon="pi pi-times" rounded outlined></Button>
                        </span>
                    </div>
